...
/bin/find . -type f -name  "*.org" -execdir sed -i -e 's/Will Chang/Will Chang/g' '{}' \;
~/ideas/standino.github.com $ /bin/find . -type f -name  "*.org" -execdir sed -i -e 's/U-360BUYAD\changwei/Will Chang/g' '{}' \;
~/ideas/standino.github.com $ /bin/find . -type f -name  "*.org" -execdir sed -i -e 's/U-360BUYAD\\changwei/Will Chang/g' '{}' \;
~/ideas/standino.github.com $ /bin/find . -type f -name  "*.org" -execdir sed -i -e 's/changwei@BJXX-CHANGWEI.360buyAD.local/changwei.cn@gmail.com/g' '{}' \;
~/ideas/standino.github.com $ /bin/find . -type f -name  "*.org" -execdir sed -i -e 's/\/wiki\//\/wiki\/html\//g' '{}' \;

/bin/find . -type f -name  "*.org" -execdir sed -i -e 's/\<#+BEGIN_SRC ' '{}' \;
