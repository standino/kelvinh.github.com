...
*find-dired* : Find a file <code> -iname d_qt_quote.sql</code> 运行外部命令 find , 产生文件列表，然后进入 dired 模式。
...
<include file="~/../emacs/lib/cw-hotkey.el" markup="src" lang="lisp">
...
<include file="orgcard.txt" markup="src" lang="">
