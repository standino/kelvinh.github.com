...
sudo yum install -y  emacs git mercurial w3m maven  subversion openssh-server texlive-beamer yum-plugin-fastestmirror community-mysql pgp-tools meld global emacs-ibus ibus-qt
