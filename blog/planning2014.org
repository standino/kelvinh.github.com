...
学习笔记就记录在@@html:<a href="/wiki/bigdata">这里吧</a>@@

** 面向对象设计和重构

软件开发了这么多年，需要提供一下设计能力了。

学习笔记就记录在@@html:<a href="/wiki/ood">这里吧</a>@@
...
学习笔记就记录在@@html:<a href="/wiki/lisp">这里吧</a>@@

** go 语言

google大牛开发的编程语言，应该很有前途。早点搭上这班车吧。考虑使用它替代shell编写一些小脚本。
学习笔记就记录在@@html:<a href="/wiki/go/">这里吧</a>@@

** Emacs 使用

重点学习一个org的使用

学习笔记就记录在@@html:<a href="/wiki/myemacs">这里吧</a>@@
